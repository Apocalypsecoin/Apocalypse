Contributing to DarkPayCoin Core
============================

The DarkPayCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DarkPayCoin Core project, and is not to be
confused with overall DarkPayCoin Network Protocol consensus changes.

Whether a pull request is merged into DarkPayCoin Core rests with the project merge
...
Patches that change DarkPayCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the DarkPayCoin consensus, it must have been
...
The project leader is the release manager for each DarkPayCoin Core release.

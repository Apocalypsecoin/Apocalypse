...
* WebSocket: [https://github.com/DarkPayCoin/insight-api-darkpaycoin#web-socket-api](https://github.com/DarkPayCoin/insight-api-darkpaycoin#web-socket-api) 
* API: [https://github.com/DarkPayCoin/insight-api-darkpaycoin#swifttx-transactions](https://github.com/DarkPayCoin/insight-api-darkpaycoin#swifttx-transactions) 
...
By default, the DarkPayCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the DarkPayCoin Core daemon:

...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop DarkPayCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "DarkPayCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DarkPayCoin features */
        {"darkpaycoin", "masternode", &masternode, true, true, false},
        {"darkpaycoin", "listmasternodes", &listmasternodes, true, true, false},
        {"darkpaycoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"darkpaycoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"darkpaycoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"darkpaycoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"darkpaycoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"darkpaycoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"darkpaycoin", "masternodedebug", &masternodedebug, true, true, false},
        {"darkpaycoin", "startmasternode", &startmasternode, true, true, false},
        {"darkpaycoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"darkpaycoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"darkpaycoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"darkpaycoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"darkpaycoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"darkpaycoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"darkpaycoin", "mnbudget", &mnbudget, true, true, false},
        {"darkpaycoin", "preparebudget", &preparebudget, true, true, false},
        {"darkpaycoin", "submitbudget", &submitbudget, true, true, false},
        {"darkpaycoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"darkpaycoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"darkpaycoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"darkpaycoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"darkpaycoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"darkpaycoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"darkpaycoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"darkpaycoin", "checkbudgets", &checkbudgets, true, true, false},
        {"darkpaycoin", "mnsync", &mnsync, true, true, false},
        {"darkpaycoin", "spork", &spork, true, true, false},
        {"darkpaycoin", "getpoolinfo", &getpoolinfo, true, true, false},
        {"darkpaycoin", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
        ...
        {"wallet", "walletpassdkpcasechange", &walletpassdkpcasechange, true, false, true},
        {"wallet", "walletpassdkpcase", &walletpassdkpcase, true, false, true},
        ...
        {"zerocoin", "getzdkpcseed", &getzdkpcseed, false, false, true},
        {"zerocoin", "setzdkpcseed", &setzdkpcseed, false, false, true}
...
{
    return "> darkpaycoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6668/\n";
}

...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("DarkPayCoin Core darkpaycoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  darkpaycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded darkpaycoin transaction") + "\n" +
                               "  darkpaycoin-tx [options] -create [commands]   " + _("Create hex-encoded darkpaycoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded darkpaycoin transaction

...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("DarkPayCoin Core"),
     ...
     * override -datadir in the darkpaycoin.conf file in the default data directory
     * (to be consistent with darkpaycoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())

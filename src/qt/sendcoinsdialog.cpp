...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    // this way we let users unlock by walletpassdkpcase or by menu
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel()) {
        ...
        {
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid DarkPayCoin address"));
        } else // Valid address
        {

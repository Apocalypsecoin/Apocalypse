...
/** Utility functions used by the DarkPayCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render DarkPayCoin addresses in monospace font
...
// Parse "darkpaycoin:" URI into recipient object, return true on successful parsing

                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzdkpcPathCustom = GetArg("-zdkpcbackuppath", "");
    ...
    if(!strzdkpcPathCustom.empty()) {
        ui->wallet_customzdkpcbackuppath->setText(QString::fromStdString(strzdkpcPathCustom));
        ui->wallet_customzdkpcbackuppath_label->setVisible(true);
        ui->wallet_customzdkpcbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzdkpcPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the DarkPayCoin RPC console.") + "<br>" +

                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DarkPayCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DarkPayCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and darkpaycoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zDKPC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DarkPayCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about DarkPayCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DarkPayCoin"));
    ...
    changePassdkpcaseAction = new QAction(QIcon(":/icons/key"), tr("&Change Passdkpcase..."), this);
    changePassdkpcaseAction->setStatusTip(tr("Change the passdkpcase used for wallet encryption"));
    unlockWalletAction = new QAction(tr("&Unlock Wallet..."), this);
    unlockWalletAction->setToolTip(tr("Unlock wallet"));
    lockWalletAction = new QAction(tr("&Lock Wallet"), this);
    signMessageAction = new QAction(QIcon(":/icons/edit"), tr("Sign &message..."), this);
    signMessageAction->setStatusTip(tr("Sign messages with your DarkPayCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DarkPayCoin addresses"));
    bip38ToolAction = new QAction(QIcon(":/icons/key"), tr("&BIP38 tool"), this);
    bip38ToolAction->setToolTip(tr("Encrypt and decrypt private keys using a passdkpcase"));
    ...
    openAction->setStatusTip(tr("Open a DarkPayCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DarkPayCoin Core help message to get a list with possible DarkPayCoin command-line options"));
    ...
    if (walletFrame) {
        ...
        connect(changePassdkpcaseAction, SIGNAL(triggered()), walletFrame, SLOT(changePassdkpcase()));
...
void BitcoinGUI::createMenuBar()
{
    ...
    if (walletFrame) {
        ...
        settings->addAction(changePassdkpcaseAction);
...
void BitcoinGUI::setWalletActionsEnabled(bool enabled)
{
    ...
    changePassdkpcaseAction->setEnabled(enabled);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DarkPayCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DarkPayCoin network", "", count));
}
...
{
    QString strTitle = tr("DarkPayCoin Core"); // default title
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unencrypted:
        ...
        changePassdkpcaseAction->setEnabled(false);
    ...
    case WalletModel::Unlocked:
        ...
        changePassdkpcaseAction->setEnabled(true);
        unlockWalletAction->setVisible(false);

...
/**
 * DarkPayCoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern std::string HelpRequiringPassdkpcase();
...
extern UniValue walletpassdkpcase(const UniValue& params, bool fHelp);
extern UniValue walletpassdkpcasechange(const UniValue& params, bool fHelp);
...
extern UniValue setzdkpcseed(const UniValue& params, bool fHelp);
extern UniValue getzdkpcseed(const UniValue& params, bool fHelp);

...
#   c) node1 mines 32 blocks, so now node 0 has 60001dkpc, node 1 has 4250dkpc, node2 has none.
#   d) node0 sends 601 dkpc to node2, in two transactions (301 dkpc, then 300 dkpc).
